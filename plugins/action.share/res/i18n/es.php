...
"125" => "Edit share",
"126" => "Editar/detener compartición ya configurada",
"127" => "Migrate legacy shares",
"128" => "Migrate legacy shares",
"129" => "Copy URL",
"130" => "Copy URL to your clipboard",
"131" => "No compartir archivos o carpetas todavía.",
"132" => "Workspace",
"133" => "Como un enlace publico",
"134" => "Como un espacio de trabajo",
"135" => "Carpeta aparecerá como un minisite en el navegador del usuario",
...
"139" => "Ha compartido esta carpeta como un espacio de trabajo con usuarios de la aplicación",
...
"151" => "Layout",
"152" => "Actualizar",
"153" => "Estándar (lista de archivos con el encabezado de la aplicación)",
"154" => "Tira de la película (bueno para galerías de imágenes)",
"155" => "Embebido (cabecera más pequeños, para los widgets)",
...
"163" => "Soltar archivos aquí (para minisites de carga habilitados)",
    ...
    "173" => "Si quieres un vínculo duradero y bonito (como https: //.../my-share-link), puede utilizar este campo. Enlace asa se generará si se deja vacía.",
